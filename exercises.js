...
function multiplyMysteryNumberByFive(mysteryNumberObject) {
  ...
  var mystery = mysteryNumberObject.mysteryNumber * 5;
  return mystery;
...
function addCalculateDiscountPriceMethod(storeItem) {
  ...
  storeItem.calculateDiscountPrice = function(){
    ...
    storeItem.discount = storeItem.price * storeItem.discountPercentage;
      storeItem.discountPrice = storeItem.price - storeItem.discount;
